...
def write_to_datastore(quiz_id, nickname, score, total_time, percentage_score):
    client = datastore.Client()
    key = client.key(FIRESTORE_TABLE)
...
def display_results():
    ...
    write_to_datastore(quiz_id, st.session_state.nickname, st.session_state.score, total_time, percentage_score)
